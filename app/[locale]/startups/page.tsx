...
async function getData() {
    const query = `*[_type == 'startup'] | order(_createdAt desc) {
        title,
          _id,
          link,
          description,
...
export default async function ProjectsPage() {
    ...
    return (
        <section className="max-w-7xl w-full px-4 md:px-8 mx-auto">
            <h1 className="text-4xl font-semibold lg:text-5xl pt-5">Startups</h1>
            <p className="leading-7 text-muted-foreground mt-2">
                Visit the web platforms of the startups I'm working on, you'll love the products
            </p>
