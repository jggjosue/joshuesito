  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
      ...
      <div className="col-span-1 lg:col-span-2 h-full min-h-[500px] lg:min-h-[300px] rounded-2xl p-8">
        ...
        <h1 className="text-4xl lg:text-5xl font-normal mt-3 ">
            I'm an engineer working and living in Mexico 🇲🇽 I invite you to visit my website and download my applications that will be available in the Google and Apple stores
        </h1>
